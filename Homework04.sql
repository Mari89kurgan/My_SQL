...
SELECT name AS 'Котики', shopname AS 'Магазины'
FROM cats 
INNER JOIN shops
...
FROM cats 
INNER JOIN shops
ON cats.shops_id = shops.id WHERE name = 'Murzik';

-- 3.Вывести магазины, в которых НЕ продаются коты “Мурзик” и “Zuza”
SELECT *
FROM shops 
LEFT JOIN cats 
ON cats.shops_id = shops.id and (name = 'Murzik'or name = 'Zuza')
WHERE name IS NULL;
...
SELECT an_name, an_cost, an_price
FROM analysis 
INNER JOIN Orders
ON an_id = ord_an WHERE ord_datetime BETWEEN '2020-02-05 00:00:00' AND '2020-02-12 23:59:59';